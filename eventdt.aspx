<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eventdt.aspx.cs" Inherits="eventdt" %>

<%@ Register Src="~/control/header.ascx" TagPrefix="uc1" TagName="header" %>
<%@ Register Src="~/control/headercss.ascx" TagPrefix="uc1" TagName="headercss" %>
<%@ Register Src="~/control/footer.ascx" TagPrefix="uc1" TagName="footer" %>
<%@ Register Src="~/control/recentevent.ascx" TagPrefix="uc1" TagName="recentevent" %>
...
<head>
    ...
    <!-- Title -->
    <title>Event Details - SEVEN STARS ACADEMY | Boarding and Day Academy, CBSE Board</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <uc1:recentevent runat="server" ID="recentevent" />
                </div>
            </div>
        </div>
    </div>
