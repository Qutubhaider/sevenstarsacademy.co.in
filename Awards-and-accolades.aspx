<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Awards-and-accolades.aspx.cs" Inherits="Awards_and_accolades" %>
...
<head>
      ...
      <title>Awards and Accolades - SEVEN STARS ACADEMY | Boarding and Day Academy, CBSE Board</title>
   ...
   <body>
    ...
    <div class="blog-area pd-top-100 pd-bottom-70">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h2 class="section-title">Awards and Accolades</h2>
               </div>
            </div>
