<%@ Page Language="C#" AutoEventWireup="true" CodeFile="noticedt.aspx.cs" Inherits="noticedt" %>

<%@ Register Src="~/control/header.ascx" TagPrefix="uc1" TagName="header" %>
<%@ Register Src="~/control/headercss.ascx" TagPrefix="uc1" TagName="headercss" %>
<%@ Register Src="~/control/footer.ascx" TagPrefix="uc1" TagName="footer" %>
<%@ Register Src="~/control/recentnotice.ascx" TagPrefix="uc1" TagName="recentnotice" %>
...
<head>
    ...
    <!-- Title -->
    <title>Notice Details - SEVEN STARS ACADEMY | Boarding and Day Academy, CBSE Board</title>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <uc1:recentnotice runat="server" ID="recentnotice" />
                </div>
            </div>
        </div>
    </div>
