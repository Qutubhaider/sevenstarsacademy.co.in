<%@ Page Language="C#" AutoEventWireup="true" CodeFile="press-relases.aspx.cs" Inherits="press_relases" %>
...
<head>
      ...
      <title>Press Relases - SEVEN STARS ACADEMY | Boarding and Day Academy, CBSE Board</title>
   ...
   <body>
    ...
    <div class="blog-area pd-top-100 pd-bottom-70">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h2 class="section-title">Press Relases</h2>
               </div>
            </div>
            <div class="row" id="Presslist" runat="server">
