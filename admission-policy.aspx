<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admission-policy.aspx.cs" Inherits="admission_policy" %>
...
<head>
    ...
    <title>Admission Policy - SEVEN STARS ACADEMY | Boarding and Day Academy, CBSE Board</title>
...
<body>
    ...
    <div class="about-our-schoor-area pd">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="section-title">Admission Policy</h2>
                </div>
            </div>
            <%--<div class="row">
                <div class="col-sm-10">
